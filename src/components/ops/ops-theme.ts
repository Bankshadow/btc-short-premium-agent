...
export const OPS_MODULE_LINKS = [
  ...
  { href: "/project-strategist", label: "Strategist", accent: "indigo" as OpsAccent },
  ...
  { href: "/strategy-garage", label: "Strategy Garage", accent: "violet" as OpsAccent },
  { href: "/strategy-lab/imports", label: "Quant Imports", accent: "violet" as OpsAccent },
  { href: "/strategy-lab/backtest", label: "Quant BT", accent: "indigo" as OpsAccent },
  { href: "/strategy-lab/tournament", label: "Tournament", accent: "amber" as OpsAccent },
  { href: "/strategy-lab/shadow", label: "Shadow", accent: "teal" as OpsAccent },
